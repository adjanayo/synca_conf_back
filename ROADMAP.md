...
| 4.12 | Emails transactionnels (Resend) | accusé réception, confirmation inscription | prod : envoi réel Resend ; dev : backend console `loguru` (email loggé, pas envoyé) — pas de conteneur SMTP de test | ✅ Test Done — image 198 Mo en CI (⚠️ marge ~2 Mo, à surveiller de très près sur les prochaines dépendances — Phase 5 paiement notamment) |
