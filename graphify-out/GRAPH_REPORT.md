...
Cohesion: 0.03
Nodes (64): AmbassadorStatusUpdate, ExhibitorStatusUpdate, PartnerStatusUpdate, SpeakerStatusUpdate, list_registrations(), RegistrationRead, AdminStatsRead, get_admin_stats() (+56 more)

### Community 1 - "Community 1"

Cohesion: 0.04
Nodes (47): Speaker, AuditLog, Base, CampaignWindow, ContactMessage, Faq, Base, DeclarativeBase (+39 more)

### Community 2 - "Community 2"

Cohesion: 0.06
Nodes (47): join_waitlist(), Payment, PromoCode, Ticket, Waitlist, PassType, make_admin_with_permission(), make_user_and_pass_type() (+39 more)

### Community 3 - "Community 3"

Cohesion: 0.08
Nodes (48): create_access_token(), Role, make_admin_with_permission(), make_ambassador(), make_exhibitor(), make_partner(), make_speaker(), test_ambassador_accepted() (+40 more)

### Community 4 - "Community 4"

Cohesion: 0.06
Nodes (42): AdminAuth, build_admin_auth(), login(), SQLAdmin login backed by the same admin_users/Argon2id/lockout path     as POST, AccountLockedError, authenticate_admin(), create_refresh_token(), _create_token() (+34 more)
...
Cohesion: 0.1
Nodes (24): Ambassador, Exhibitor, Partner, PartnerLevel, make_speaker(), test_ambassador_social_handles_json(), test_exhibitor_default_status_and_public(), test_partner_negotiation_workflow() (+16 more)

### Community 7 - "Community 7"

Cohesion: 0.09
Nodes (24): update_ambassador_status(), _validate_promo_code(), create_payment(), payment_webhook(), validate_promo(), compute_discounted_amount(), generate_ambassador_promo_code(), get_valid_promo_code() (+16 more)

### Community 8 - "Community 8"

Cohesion: 0.11
Nodes (26): application_received_email(), TODO.md: HTML email templates.  Table-based, inline-CSS layout (the only markup, registration_confirmed_email(), _render(), ticket_delivered_email(), apply_as_ambassador(), apply_as_exhibitor(), apply_as_partner() (+18 more)
...
- **Thin community `Community 44`** (2 nodes): `list_contacts()`, `admin_contacts.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (2 nodes): `test_health()`, `test_health.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `rate_limit.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 55`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Generate the ticket's PDF+QR, upload it, and email it.      Runs as a Background`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.