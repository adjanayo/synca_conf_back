...
8. `AdminUser` - 16 edges
9. `get_settings()` - 15 edges
10. `Payment` - 15 edges
...
Cohesion: 0.09
Nodes (28): AdminAuth, build_admin_auth(), login(), SQLAdmin login backed by the same admin_users/Argon2id/lockout path     as POST, AccountLockedError, authenticate_admin(), create_refresh_token(), _create_token() (+20 more)
