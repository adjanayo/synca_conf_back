...
sequenceDiagram
    ...
    participant P4 as make_ticket()
    participant P5 as make_verified_user()
    participant P6 as EncryptedString
    participant P7 as test_webhook_increments_promo_usage_count_on_completion()
    participant P8 as make_user()
    participant P9 as make_payment()
    participant P10 as make_payment()
    participant P11 as register()
    participant P12 as make_user()
    participant P13 as make_user()
    participant P14 as make_user_and_pass()
    ...
    participant P19 as test_user_and_profile_read()
