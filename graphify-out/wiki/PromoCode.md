...
sequenceDiagram
    ...
    participant P51 as generate_ambassador_promo_code()
    participant P52 as test_promo_code_and_waitlist_unique()
    participant P53 as test_promo_validate_success()
    participant P54 as test_promo_validate_inactive_400()
    participant P55 as test_promo_validate_expired_400()
    participant P56 as test_promo_validate_exhausted_400()
    participant P57 as test_promo_validate_fixed_discount()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
