...
> God node · 16 connections · [/Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/models/payments.py](file:///Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/models/payments.py#L37)
...
sequenceDiagram
    ...
    participant P56 as create_payment()
    participant P57 as test_ticket_one_per_payment()
    participant P58 as test_payment_default_status_pending()
    participant P59 as test_payment_requires_valid_fk()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
