...
- [hackathon.py](file:///Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/schemas/hackathon.py#L1) (6 connections)
...
- [ParticipantCreate](file:///Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/schemas/participants.py#L16) (3 connections)
- [ParticipantRead](file:///Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/schemas/participants.py#L4) (3 connections)
...
classDiagram
    ...
    class AmbassadorPublicRead {
        +applications.py()
    }
    class AmbassadorRead {
        +applications.py()
    }
    class ExhibitorPublicRead {
        +applications.py()
    }
    class ExhibitorRead {
        +applications.py()
    }
    class PartnerPublicRead {
        +applications.py()
    }
    class PartnerRead {
        +applications.py()
    }
    class SpeakerPublicRead {
        +applications.py()
    }
    class SpeakerRead {
        +applications.py()
    ...
    class HackathonTeamCreate {
        +hackathon.py()
    }
    class HackathonTeamMemberCreate {
        +hackathon.py()
    }
    class HackathonTeamMemberRead {
        +hackathon.py()
    }
    class HackathonTeamMemberUpdate {
        +hackathon.py()
    }
    class HackathonTeamRead {
        +hackathon.py()
    }
    class HackathonTeamUpdate {
        +hackathon.py()
    }
    ...
    class PartnerBenefitCreate {
        +referentials.py()
    }
    class PartnerBenefitRead {
        +referentials.py()
    }
    class PartnerBenefitUpdate {
        +referentials.py()
    }
...
- [/Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/schemas/hackathon.py](file:///Users/kodjododjango/Downloads/dev_projects/synca_conf_back/app/schemas/hackathon.py)
