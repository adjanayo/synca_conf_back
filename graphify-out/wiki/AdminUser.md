...
sequenceDiagram
    ...
    participant P69 as main()
    participant P70 as create_admin_user()
    participant P71 as make_admin()
    participant P72 as test_rbac_read()
    participant P73 as test_admin_user_requires_permission_only_superadmin()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
