...
sequenceDiagram
    ...
    participant P49 as EncryptedString
    participant P50 as make_user()
    participant P51 as make_user()
    participant P52 as register()
    participant P53 as make_user()
    participant P54 as make_user()
    participant P55 as test_user_and_profile_read()
    participant P56 as test_null_special_needs_stays_null()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
