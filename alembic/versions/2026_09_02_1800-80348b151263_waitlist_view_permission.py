"""waitlist.view permission

Revision ID: 80348b151263
Revises: 547ad7a3ad02
...
revision: str = '80348b151263'
down_revision: str | Sequence[str] | None = '547ad7a3ad02'
...
def upgrade() -> None:
    """Upgrade schema."""
    # New permission (Phase K): admin GET /api/admin/waitlist.
