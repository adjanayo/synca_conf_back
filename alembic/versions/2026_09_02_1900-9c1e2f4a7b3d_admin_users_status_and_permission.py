"""admin_users.status column + admin_users.manage permission

Revision ID: 9c1e2f4a7b3d
Revises: 80348b151263
...
revision: str = '9c1e2f4a7b3d'
down_revision: str | Sequence[str] | None = '80348b151263'
